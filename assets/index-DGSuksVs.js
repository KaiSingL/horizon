...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(e,t,n){let r=new Float32Array(Oo),i=new K(0,1,0);return new oa({name:`SphericalGaussianBlur`,defines:{n:Oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Uo(){return new oa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wo(){return new oa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Go(),fragmentShader:`
	...
	`}var Ko=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},eu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},tu=new Ua(-1,1,1,-1,0,1),nu=new class extends Er{constructor(){super(),this.setAttribute(`position`,new mr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new mr([0,2,0,0,2,0],2))}},ru=class{constructor(e){this._mesh=new mi(nu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,tu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},iu=class extends eu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof oa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ra.clone(e.uniforms),this.material=new oa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ru(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},au=class extends eu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},ou=class extends eu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},su=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Gt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new iu($l),this.copyPass.material.blending=0,this.timer=new Ya}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}au!==void 0&&(r instanceof au?n=!0:r instanceof ou&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},cu=class extends eu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},lu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};uu.BlurDirectionX=new G(1,0),uu.BlurDirectionY=new G(0,1);var du={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},fu=class extends eu{constructor(){super(),this.isOutputPass=!0,this.uniforms=ra.clone(du.uniforms),this.material=new sa({name:du.name,uniforms:this.uniforms,vertexShader:du.vertexShader,fragmentShader:du.fragmentShader}),this._fsQuad=new ru(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};function pu(e=Math.random){let t=new Cn;return t.name=`starfield`,t.add(mu({count:8e3,radius:900,size:.7,rng:e,brightness:.85})),t.add(mu({count:2500,radius:700,size:1.4,rng:e,brightness:1,colorful:!0})),t.add(mu({count:400,radius:500,size:2.2,rng:e,brightness:1.15,colorful:!0})),t.add(hu(e)),t.add(gu(e)),t}function mu({count:e,radius:t,size:n,rng:r,brightness:i=1,colorful:a=!1}){let o=new Float32Array(e*3),s=new Float32Array(e*3),c=new Float32Array(e),l=[new Y(16777215),new Y(11061503),new Y(16770229),new Y(16763040),new Y(13164799),new Y(16772829)];for(let u=0;u<e;u++){let e=r(),d=r(),f=2*Math.PI*e,p=Math.acos(2*d-1),m=t*(.75+r()*.25);o[u*3]=m*Math.sin(p)*Math.cos(f),o[u*3+1]=m*Math.sin(p)*Math.sin(f),o[u*3+2]=m*Math.cos(p);let h=a?l[r()*l.length|0]:l[0],g=i*(.45+r()*.55);s[u*3]=h.r*g,s[u*3+1]=h.g*g,s[u*3+2]=h.b*g,c[u]=n*(.5+r())}let u=new Er;u.setAttribute(`position`,new dr(o,3)),u.setAttribute(`color`,new dr(s,3)),u.setAttribute(`aSize`,new dr(c,1));let d=new Vi(u,new oa({transparent:!0,depthWrite:!1,blending:2,vertexColors:!0,uniforms:{uScale:{value:n}},vertexShader:`
    ...
    `}));return d.frustumCulled=!1,d}function hu(e){let t=6e3,n=new Float32Array(t*3),r=new Float32Array(t*3),i=1.05;for(let a=0;a<t;a++){let t=e()*Math.PI*2,o=Math.sin(t*2.5)*40,s=(e()-.5)*(25+Math.abs(o)*.3),c=200+e()*550,l=Math.cos(t)*c+(e()-.5)*30,u=s+o*.15,d=Math.sin(t)*c+(e()-.5)*30,f=u*Math.cos(i)-d*Math.sin(i),p=u*Math.sin(i)+d*Math.cos(i);u=f,d=p,n[a*3]=l,n[a*3+1]=u,n[a*3+2]=d;let m=e()>.55,h=.15+e()*.35;m?(r[a*3]=.85*h,r[a*3+1]=.75*h,r[a*3+2]=.95*h):(r[a*3]=.55*h,r[a*3+1]=.65*h,r[a*3+2]=1*h)}let a=new Er;a.setAttribute(`position`,new dr(n,3)),a.setAttribute(`color`,new dr(r,3));let o=new Vi(a,new Ii({size:1.6,vertexColors:!0,transparent:!0,opacity:.7,depthWrite:!1,blending:2,sizeAttenuation:!0}));return o.frustumCulled=!1,o}function gu(e){let t=new Cn,n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`),i=r.createRadialGradient(128,128,10,128,128,128);i.addColorStop(0,`rgba(120,160,255,0.55)`),i.addColorStop(.35,`rgba(80,100,200,0.18)`),i.addColorStop(1,`rgba(0,0,0,0)`),r.fillStyle=i,r.fillRect(0,0,256,256);let a=new Wi(n),o=[6719692,8939178,5609898,11171669,6715323];for(let n=0;n<5;n++){let r=new Kr(new Mr({map:a,color:o[n%o.length],transparent:!0,opacity:.12+e()*.1,depthWrite:!1,blending:2})),i=e()*Math.PI*2,s=350+e()*200;r.position.set(Math.cos(i)*s,(e()-.5)*120,Math.sin(i)*s);let c=80+e()*140;r.scale.set(c,c*(.6+e()*.5),1),t.add(r)}return t}var _u=.55,vu=3.2,yu=[{id:`sun`,name:`Sun`,type:`Star · G2V`,color:`#ffcc66`,emissive:`#ffaa33`,a:0,e:0,i:0,period:0,radius:109,day:25.4,axialTilt:7.25,blurb:`A G-type main-sequence star — 99.86% of the system’s mass. Nuclear fusion in its core powers light, wind, and the gravitational ballet of the planets.`},{id:`mercury`,name:`Mercury`,type:`Terrestrial`,color:`#9a9a9a`,a:.387,e:.2056,i:7,period:87.969,radius:.383,day:58.646,axialTilt:.03,meanAnomaly0:174.8,node:48.3,argPeri:29.1,blurb:`The innermost world: a cratered, airless rock with the most eccentric orbit among the classical planets and extreme day–night temperature swings.`},{id:`venus`,name:`Venus`,type:`Terrestrial`,color:`#e8c99a`,a:.723,e:.0068,i:3.39,period:224.701,radius:.949,day:-243.025,axialTilt:177.4,meanAnomaly0:50.4,node:76.7,argPeri:54.9,blurb:`Earth’s twin in size, wrapped in a crushing CO₂ atmosphere. Slow retrograde spin makes a Venusian day longer than its year.`},{id:`earth`,name:`Earth`,type:`Terrestrial`,color:`#4f8fd8`,a:1,e:.0167,i:0,period:365.256,radius:1,day:.997,axialTilt:23.44,meanAnomaly0:357.5,node:0,argPeri:114.2,blurb:`Our home — liquid water, a magnetic shield, and a large Moon that stabilizes the axial tilt. The reference for AU and the day.`,moons:[{name:`Moon`,a:.09,period:27.322,radius:.272,color:`#c8c4b8`}]},{id:`mars`,name:`Mars`,type:`Terrestrial`,color:`#c45c3e`,a:1.524,e:.0934,i:1.85,period:686.98,radius:.532,day:1.026,axialTilt:25.19,meanAnomaly0:19.4,node:49.6,argPeri:286.5,blurb:`The red planet: thin CO₂ air, polar ice, and evidence of ancient rivers. Two tiny moons — Phobos and Deimos — orbit nearby.`},{id:`jupiter`,name:`Jupiter`,type:`Gas giant`,color:`#d4a574`,a:5.203,e:.0484,i:1.3,period:4332.59,radius:11.21,day:.414,axialTilt:3.13,meanAnomaly0:20,node:100.5,argPeri:273.9,blurb:`King of planets — a hydrogen–helium world with a fierce storm system and a miniature system of moons. Dominates outer-system dynamics.`},{id:`saturn`,name:`Saturn`,type:`Gas giant`,color:`#e8d5a3`,a:9.537,e:.0539,i:2.49,period:10759.22,radius:9.45,day:.444,axialTilt:26.73,meanAnomaly0:317,node:113.7,argPeri:339.4,blurb:`Low-density giant famous for its icy ring system. Less massive than Jupiter but more visually iconic from afar.`,rings:{inner:1.2,outer:2.25,color:`#d4c4a0`,opacity:.75}},{id:`uranus`,name:`Uranus`,type:`Ice giant`,color:`#9fd9e0`,a:19.191,e:.0472,i:.77,period:30688.5,radius:4.01,day:-.718,axialTilt:97.77,meanAnomaly0:142.2,node:74,argPeri:96.5,blurb:`An ice giant tipped on its side — seasons last decades. Methane in the atmosphere gives the pale cyan hue.`},{id:`neptune`,name:`Neptune`,type:`Ice giant`,color:`#4169e1`,a:30.07,e:.0086,i:1.77,period:60182,radius:3.88,day:.671,axialTilt:28.32,meanAnomaly0:256.2,node:131.8,argPeri:273.2,blurb:`The outermost classical planet: deep blue methane atmosphere, supersonic winds, and the distant moon Triton in retrograde orbit.`}];function bu(e){if(e.id===`sun`)return vu;let t=e.radius*_u;return e.radius>3?_u*(1.4+Math.log10(e.radius)*2.8):Math.max(t,.18)}var xu=Math.PI/180;function Su(e,t){let n=(e+Math.PI)%(2*Math.PI)-Math.PI;n<-Math.PI&&(n+=2*Math.PI);let r=t<.8?n:Math.PI;for(let e=0;e<12;e++){let e=(r-t*Math.sin(r)-n)/(1-t*Math.cos(r));if(r-=e,Math.abs(e)<1e-10)break}return r}function Cu(e,t,n,r){if(!e.a||e.period<=0)return r.x=0,r.y=0,r.z=0,r;let i=2*Math.PI/e.period,a=(e.meanAnomaly0??0)*xu+i*t,o=e.e,s=Su(a,o),c=Math.cos(s),l=Math.sin(s),u=Math.sqrt(1-o*o),d=(c-o)/(1-o*c),f=u*l/(1-o*c),p=e.a*(1-o*c)*n,m=p*d,h=p*f,g=(e.argPeri??0)*xu,_=(e.i??0)*xu,v=(e.node??0)*xu,y=Math.cos(g),b=Math.sin(g),x=Math.cos(_),S=Math.sin(_),C=Math.cos(v),w=Math.sin(v),T=m*y-h*b,E=m*b+h*y,D=T,O=E*S,k=E*x;return r.x=D*C-k*w,r.y=O,r.z=D*w+k*C,r}function wu(e,t,n=256){let r=new Float32Array((n+1)*3);for(let i=0;i<=n;i++){let a=i/n*Math.PI*2,o=e.e,s=e.a*t*(1-o*o)/(1+o*Math.cos(a)),c=s*Math.cos(a),l=s*Math.sin(a),u=(e.argPeri??0)*xu,d=(e.i??0)*xu,f=(e.node??0)*xu,p=Math.cos(u),m=Math.sin(u),h=Math.cos(d),g=Math.sin(d),_=Math.cos(f),v=Math.sin(f),y=c*p-l*m,b=c*m+l*p,x=b*g,S=b*h;c=y*_-S*v;let C=x;l=y*v+S*_,r[i*3]=c,r[i*3+1]=C,r[i*3+2]=l}return r}var Tu={x:0,y:0,z:0};function Eu(e){let t=new Cn;t.name=`solarSystem`,e.add(t);let n=new Map,r=new Cn;r.name=`orbits`,t.add(r);let i=new Cn;i.name=`trails`,i.visible=!1,t.add(i);let a=Mu();a.visible=!1,t.add(a);for(let e of yu){let a=Du(e);if(t.add(a.pivot),n.set(e.id,a),e.a>0){let t=Au(e);r.add(t),a.orbitLine=t;let n=ju(e);i.add(n.line),a.trail=n}}return{root:t,byId:n,orbitGroup:r,trailGroup:i,ecliptic:a,bodies:yu,update(e,{animate:t=!0}={}){for(let r of yu){let i=n.get(r.id);if(i){if(r.day!==0){let t=e/r.day;i.mesh.rotation.y=t*Math.PI*2}if(r.id!==`sun`){if(Cu(r,e,28,Tu),i.pivot.position.set(Tu.x,Tu.y,Tu.z),i.moons)for(let t of i.moons){let n=e/t.period*Math.PI*2;t.mesh.position.set(Math.cos(n)*t.a*28,0,Math.sin(n)*t.a*28)}t&&i.trail&&i.trail.push(Tu.x,Tu.y,Tu.z)}}}},setOrbitsVisible(e){r.visible=e},setTrailsVisible(e){if(i.visible=e,!e)for(let e of n.values())e.trail&&e.trail.clear()},setEclipticVisible(e){a.visible=e}}}function Du(e){let t=new Cn;t.name=e.id;let n=bu(e),r;r=e.id===`sun`?Ou(n):ku(e,n),r.rotation.z=Tt.degToRad(e.axialTilt||0),t.add(r);let i={def:e,pivot:t,mesh:r};if(e.moons?.length){i.moons=[];for(let n of e.moons){let e=new mi(new Zi(Math.max(n.radius*.35,.08),24,24),new ca({color:n.color,roughness:.9,metalness:.05}));e.castShadow=!1,t.add(e),i.moons.push({mesh:e,a:n.a,period:n.period})}}return i}function Ou(e){let t=new Cn,n=new mi(new Zi(e,64,64),new ni({color:16763989}));t.add(n);let r=new mi(new Zi(e*1.15,48,48),new ni({color:16755234,transparent:!0,opacity:.35,blending:2,depthWrite:!1,side:1}));t.add(r);let i=new mi(new Zi(e*1.55,48,48),new ni({color:16746496,transparent:!0,opacity:.12,blending:2,depthWrite:!1,side:1}));t.add(i);let a=new Kr(new Mr({map:Nu(`#ffdd88`,`#ff6600`),color:16764006,transparent:!0,opacity:.55,blending:2,depthWrite:!1}));a.scale.set(e*6,e*6,1),t.add(a);let o=new Ha(16773328,2.8,0,.35);o.position.set(0,0,0),t.add(o);let s=new Ha(8952268,.15,0,.5);return t.add(s),t}function ku(e,t){let n=new Cn,r=e.radius>3?48:40,i=new mi(new Zi(t,r,r),new ca({map:Pu(e),color:16777215,roughness:e.type.includes(`Gas`)||e.type.includes(`Ice`)?.55:.78,metalness:.08,emissive:new Y(e.color).multiplyScalar(.04)}));if(n.add(i),e.id===`earth`||e.id===`uranus`||e.id===`neptune`||e.id===`venus`){let r=e.id===`earth`?7255807:e.id===`venus`?16768426:8969727,i=new mi(new Zi(t*1.06,32,32),new ni({color:r,transparent:!0,opacity:e.id===`venus`?.18:.14,blending:2,depthWrite:!1,side:1}));n.add(i)}if(e.rings){let{inner:r,outer:i,color:a,opacity:o}=e.rings,s=new Xi(t*r,t*i,96),c=s.attributes.position,l=s.attributes.uv;for(let e=0;e<c.count;e++){let n=c.getX(e),a=c.getY(e),o=(Math.sqrt(n*n+a*a)-t*r)/(t*(i-r));l.setXY(e,o,.5)}let u=new mi(s,new ni({map:Fu(a),color:16777215,side:2,transparent:!0,opacity:o,depthWrite:!1}));u.rotation.x=Math.PI/2,n.add(u)}return n}function Au(e){let t=wu(e,28,360),n=new Er;n.setAttribute(`position`,new dr(t,3));let r=new Y(e.color);r.multiplyScalar(.55);let i=new Pi(n,new Ei({color:r,transparent:!0,opacity:.35,depthWrite:!1}));return i.name=`orbit-${e.id}`,i}function ju(e,t=400){let n=new Float32Array(t*3),r=new Er;r.setAttribute(`position`,new dr(n,3)),r.setDrawRange(0,0);let i=new Pi(r,new Ei({color:new Y(e.color),transparent:!0,opacity:.55,depthWrite:!1})),a=0,o=0,s=0;return{line:i,push(e,i,c){if(s++,s%2==0){if(n[a*3]=e,n[a*3+1]=i,n[a*3+2]=c,a=(a+1)%t,o=Math.min(o+1,t),o<t)r.setDrawRange(0,o);else{let e=new Float32Array(t*3);for(let r=0;r<t;r++){let i=(a+r)%t*3;e[r*3]=n[i],e[r*3+1]=n[i+1],e[r*3+2]=n[i+2]}r.attributes.position.array.set(e),r.setDrawRange(0,t)}r.attributes.position.needsUpdate=!0}},clear(){a=0,o=0,r.setDrawRange(0,0)}}}function Mu(){let e=new Cn,t=new Ei({color:3821696,transparent:!0,opacity:.2,depthWrite:!1});for(let n of[1,5,10,20,30]){let r=[],i=n*28;for(let e=0;e<=128;e++){let t=e/128*Math.PI*2;r.push(new K(Math.cos(t)*i,0,Math.sin(t)*i))}let a=new Er().setFromPoints(r);e.add(new Pi(a,t))}let n=new Ei({color:4874384,transparent:!0,opacity:.25,depthWrite:!1});return e.add(new Pi(new Er().setFromPoints([new K(-896,0,0),new K(896,0,0)]),n)),e.add(new Pi(new Er().setFromPoints([new K(0,0,-896),new K(0,0,896)]),n)),e}function Nu(e,t){let n=document.createElement(`canvas`);n.width=n.height=256;let r=n.getContext(`2d`),i=r.createRadialGradient(128,128,0,128,128,128);i.addColorStop(0,e),i.addColorStop(.25,t),i.addColorStop(.55,`rgba(255,100,0,0.15)`),i.addColorStop(1,`rgba(0,0,0,0)`),r.fillStyle=i,r.fillRect(0,0,256,256);let a=new Wi(n);return a.colorSpace=Re,a}function Pu(e){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=e.color;n.fillStyle=r,n.fillRect(0,0,512,256);let i=n.getImageData(0,0,512,256),a=i.data,o=Iu(e.id);for(let t=0;t<256;t++)for(let n=0;n<512;n++){let i=(t*512+n)*4,s=zu(n*.02+o,t*.04+o*.3)*.5+zu(n*.06,t*.1)*.25;if(e.id===`earth`)s>.12?(a[i]=60+s*80,a[i+1]=110+s*90,a[i+2]=50+s*40):(a[i]=40+s*30,a[i+1]=90+s*50,a[i+2]=180+s*40),(t<28||t>228)&&(a[i]=a[i+1]=a[i+2]=230);else if(e.type.includes(`Gas`)||e.type.includes(`Ice`)){let n=Math.sin(t*.12+s*3)*.5+.5,o=new Y(r);o.offsetHSL(0,0,(n-.5)*.18+s*.08),a[i]=o.r*255|0,a[i+1]=o.g*255|0,a[i+2]=o.b*255|0,e.id===`jupiter`&&Math.abs(t-150)<12&&s>.2&&(a[i]=200,a[i+1]=90,a[i+2]=60)}else if(e.id===`mars`){let e=new Y(r);e.offsetHSL(0,0,s*.15-.05),a[i]=e.r*255|0,a[i+1]=e.g*255|0,a[i+2]=e.b*255|0,(t<20||t>236)&&(a[i]=220,a[i+1]=230,a[i+2]=240)}else{let e=new Y(r);e.offsetHSL(0,0,s*.12-.06),a[i]=e.r*255|0,a[i+1]=e.g*255|0,a[i+2]=e.b*255|0}a[i+3]=255}n.putImageData(i,0,0);let s=new Wi(t);return s.colorSpace=Re,s.anisotropy=4,s}function Fu(e){let t=document.createElement(`canvas`);t.width=512,t.height=8;let n=t.getContext(`2d`),i=new Y(e);for(let e=0;e<512;e++){let t=e/512,r=Math.abs(t-.55)<.03?.05:1,a=(.35+.65*Math.abs(Math.sin(t*40)))*r;n.fillStyle=`rgba(${i.r*255|0},${i.g*255|0},${i.b*255|0},${a})`,n.fillRect(e,0,1,8)}let a=new Wi(t);return a.colorSpace=Re,a.wrapS=r,a}function Iu(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;return(t>>>0)%1e3}function Lu(e,t){let n=Math.sin(e*127.1+t*311.7)*43758.5453;return n-Math.floor(n)}function Ru(e,t){let n=Math.floor(e),r=Math.floor(t),i=e-n,a=t-r,o=i*i*(3-2*i),s=a*a*(3-2*a),c=Lu(n,r),l=Lu(n+1,r),u=Lu(n,r+1),d=Lu(n+1,r+1);return c+(l-c)*o+(u-c)*s+(c-l-u+d)*o*s}function zu(e,t){let n=0,r=.5,i=1;for(let a=0;a<4;a++)n+=r*Ru(e*i,t*i),r*=.5,i*=2;return n}var Bu=1e3,Vu=1/24,Hu=365.25*100;function Uu(e){let t=Math.max(0,Math.min(Bu,Number(e)))/Bu,n=Math.log(Vu);return Math.exp(n+t*(Math.log(Hu)-n))}function Wu(e){let t=(Math.log(Math.max(Vu,Math.min(Hu,e)))-Math.log(Vu))/(Math.log(Hu)-Math.log(Vu));return Math.round(t*Bu)}function Gu(e){return e<=0?`Paused`:e<1/12||e<1?`${qu(e*24)} h / s`:e<30?`${qu(e)} day / s`:e<365.25?`${qu(e/30.44)} mo / s`:`${qu(e/365.25)} yr / s`}function Ku(e){let t=e>=0?`+`:`−`,n=Math.abs(e);if(n<365.25)return`J2000 ${t} ${qu(n,1)}d`;let r=n/365.25;return r<100?`J2000 ${t} ${qu(r,2)}y`:`J2000 ${t} ${qu(r,1)}y`}function qu(e,t=2){return e>=100?e.toFixed(0):e>=10?e.toFixed(1):e.toFixed(t)}function Ju(e){return!e||e<=0?`—`:e<400?`${e.toFixed(1)} d`:`${(e/365.25).toFixed(2)} yr`}function Yu(e){return e?e<.01?`${(e*149597870.7).toFixed(0)} km`:`${e.toFixed(3)} AU`:`—`}function Xu(e){return e>50?`${e.toFixed(0)} R⊕`:`${e.toFixed(2)} R⊕`}function Zu(e){if(e===0)return`—`;let t=Math.abs(e),n=e<0?` (ret.)`:``;return t<2?`${(t*24).toFixed(1)} h${n}`:`${t.toFixed(2)} d${n}`}var Qu=document.getElementById(`c`),$u=new Al({canvas:Qu,antialias:!0,powerPreference:`high-performance`,alpha:!1});$u.setPixelRatio(Math.min(window.devicePixelRatio,2)),$u.setSize(window.innerWidth,window.innerHeight),$u.outputColorSpace=Re,$u.toneMapping=4,$u.toneMappingExposure=1.05;var ed=new Mn;ed.background=new Y(197898),ed.fog=new jn(197898,22e-5);var td=new Ba(50,window.innerWidth/window.innerHeight,.05,2500);td.position.set(0,45,95);var nd=new Bl(td,Qu);nd.enableDamping=!0,nd.dampingFactor=.06,nd.minDistance=2,nd.maxDistance=900,nd.target.set(0,0,0),nd.maxPolarAngle=Math.PI*.95,ed.add(new Wa(1712696,.35));var rd=new Oa(10205439,526866,.25);ed.add(rd);var id=pu();ed.add(id);var ad=Eu(ed),od=new su($u);od.addPass(new cu(ed,td));var sd=new uu(new G(window.innerWidth,window.innerHeight),.55,.6,.85);od.addPass(sd),od.addPass(new fu);var cd=0,ld=!0,ud=Uu(Wu(1)),dd=`sun`,fd=!0,$={active:!1,follow:!0,offset:new K(8,4,12),targetPos:new K},pd=e=>document.getElementById(e),md=pd(`epoch-label`),hd=pd(`speed-label`),gd=pd(`focus-label`),_d=pd(`warp-readout`),vd=pd(`time-slider`),yd=pd(`body-list`),bd=pd(`info-name`),xd=pd(`info-type`),Sd=pd(`info-distance`),Cd=pd(`info-period`),wd=pd(`info-ecc`),Td=pd(`info-incl`),Ed=pd(`info-radius`),Dd=pd(`info-day`),Od=pd(`info-blurb`),kd=pd(`btn-play`),Ad=kd.querySelector(`.icon-play`),jd=kd.querySelector(`.icon-pause`),Md=document.createElement(`div`);Md.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:5;`,document.getElementById(`app`).appendChild(Md);var Nd=new Map,Pd=new K;function Fd(){yd.innerHTML=``;for(let e of ad.bodies){let t=document.createElement(`button`);t.type=`button`,t.className=`body-item`+(e.id===dd?` active`:``),t.dataset.id=e.id,t.setAttribute(`role`,`option`),t.setAttribute(`aria-selected`,e.id===dd?`true`:`false`);let n=document.createElement(`span`);n.className=`body-swatch`,n.style.background=e.color,n.style.color=e.color;let r=document.createElement(`span`);r.className=`name`,r.textContent=e.name;let i=document.createElement(`span`);i.className=`dist`,i.textContent=e.a?`${e.a.toFixed(2)} AU`:`center`,t.append(n,r,i),t.addEventListener(`click`,()=>Ld(e.id)),yd.appendChild(t);let a=document.createElement(`div`);a.className=`world-label visible`,a.innerHTML=`<span class="dot" style="background:${e.color};color:${e.color}"></span>${e.name}`,Md.appendChild(a),Nd.set(e.id,a)}pd(`body-count`).textContent=String(ad.bodies.length),vd.min=`0`,vd.max=String(Bu),vd.step=`1`,vd.value=String(Wu(ud)),Id(dd),Bd(),Vd()}function Id(e){let t=ad.bodies.find(t=>t.id===e);t&&(bd.textContent=t.name,xd.textContent=t.type,Sd.textContent=t.a?Yu(t.a):`—`,Cd.textContent=Ju(t.period),wd.textContent=t.a?t.e.toFixed(4):`—`,Td.textContent=t.a?`${t.i.toFixed(2)}°`:`—`,Ed.textContent=Xu(t.radius),Dd.textContent=Zu(t.day),Od.textContent=t.blurb,gd.textContent=t.name,yd.querySelectorAll(`.body-item`).forEach(t=>{let n=t.dataset.id===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`)}))}function Ld(e,t=!0){dd=e,$.follow=!0,Id(e);let n=ad.byId.get(e);if(!n)return;let r=n.pivot.position.clone();e===`sun`||Math.max(n.mesh.scale?.x||1,1);let i=e===`sun`?8:2;n.mesh.traverse(e=>{e.geometry?.boundingSphere&&(e.geometry.computeBoundingSphere(),i=Math.max(i,e.geometry.boundingSphere.radius*2.5))}),t&&($.offset.set(i*3.2,i*1.4,i*3.5),e===`sun`&&$.offset.set(20,12,35),(e===`neptune`||e===`uranus`)&&$.offset.set(i*4,i*2,i*5));let a=r.clone(),o=r.clone().add($.offset);$.active=!0,$._fromCam=td.position.clone(),$._fromTarget=nd.target.clone(),$._toCam=o,$._toTarget=a,$._t=0}function Rd(){dd=`sun`,$.follow=!1,$.active=!0,$._fromCam=td.position.clone(),$._fromTarget=nd.target.clone(),$._toCam=new K(0,80,160),$._toTarget=new K(0,0,0),$._t=0,Id(`sun`)}function zd(){$.follow=!1,$.active=!1}function Bd(){Ad.hidden=ld,jd.hidden=!ld,kd.setAttribute(`aria-label`,ld?`Pause`:`Play`)}function Vd(){let e=Gu(ld?ud:0);_d.textContent=e,hd.textContent=e}vd.addEventListener(`input`,()=>{ud=Uu(Number(vd.value)),Vd()}),kd.addEventListener(`click`,()=>{ld=!ld,Bd(),Vd()}),pd(`btn-reset`).addEventListener(`click`,()=>{cd=0,ad.setTrailsVisible(pd(`tog-trails`).checked)}),pd(`tog-orbits`).addEventListener(`change`,e=>{ad.setOrbitsVisible(e.target.checked)}),pd(`tog-labels`).addEventListener(`change`,e=>{fd=e.target.checked,Nd.forEach(e=>e.classList.toggle(`visible`,fd))}),pd(`tog-trails`).addEventListener(`change`,e=>{ad.setTrailsVisible(e.target.checked)}),pd(`tog-helpers`).addEventListener(`change`,e=>{ad.setEclipticVisible(e.target.checked)}),pd(`btn-free`).addEventListener(`click`,zd),pd(`btn-system`).addEventListener(`click`,Rd),window.addEventListener(`keydown`,e=>{if(!e.target.matches(`input, textarea`)){if(e.code===`Space`&&(e.preventDefault(),ld=!ld,Bd(),Vd()),(e.key===`r`||e.key===`R`)&&(cd=0),e.key>=`1`&&e.key<=`9`){let t=Number(e.key)-1,n=ad.bodies[t];n&&Ld(n.id)}e.key===`0`&&Rd()}}),window.addEventListener(`resize`,()=>{let e=window.innerWidth,t=window.innerHeight;td.aspect=e/t,td.updateProjectionMatrix(),$u.setSize(e,t),od.setSize(e,t),sd.setSize(e,t)}),nd.addEventListener(`start`,()=>{$.active=!1});var Hd=new lo;function Ud(){requestAnimationFrame(Ud);let e=Math.min(Hd.getDelta(),.1),t=ld;if(t&&(cd+=ud*e),ad.update(cd,{animate:t}),t&&(id.rotation.y+=e*.0015),$.active){$._t=Math.min(1,$._t+e*1.4);let t=Gd($._t);td.position.lerpVectors($._fromCam,$._toCam,t),nd.target.lerpVectors($._fromTarget,$._toTarget,t),$._t>=1&&($.active=!1)}else if($.follow&&dd){let t=ad.byId.get(dd);if(t){$.targetPos.copy(t.pivot.position);let n=nd.target.clone();nd.target.lerp($.targetPos,1-Math.exp(-4*e));let r=nd.target.clone().sub(n);td.position.add(r)}}nd.update(),Wd(),md.textContent=Ku(cd),od.render()}function Wd(){for(let[e,t]of Nd){let n=ad.byId.get(e);if(!n)continue;Pd.copy(n.pivot.position),Pd.project(td);let r=Pd.z>1,i=(Pd.x*.5+.5)*window.innerWidth,a=(-Pd.y*.5+.5)*window.innerHeight,o=fd&&!r&&i>-40&&i<window.innerWidth+40&&a>-40&&a<window.innerHeight+40;t.classList.toggle(`visible`,o),o&&(t.style.transform=`translate(${i}px, ${a}px) translate(-50%, -120%)`)}}function Gd(e){return 1-(1-e)**3}Fd(),ad.update(0),Rd(),setTimeout(()=>{$.follow=!1},900),Ud();